...
;; VERSION: 5.0 (Standalone Pop-up Mode)

[System: Formula]
    ParcelTrackerURL: "${appUrl}/api/tally/check-lr"

;; ==========================================
;; 1. GLOBAL SHORTCUT & MENU
;; ==========================================

;; Add verification to Gateway
[#Menu: Gateway of Tally]
    Add: Item: "Check Parcel Tracker (Ctrl+Alt+P)" : Display: ParcelTrackerReport

;; Global Key to open the tracker from ANYWHERE (including Purchase Voucher)
[System: Key]
    Key: Ctrl + Alt + P : Display: ParcelTrackerReport

;; Also add a visible button to Purchase Screen
[#Form: Purchase Color]
